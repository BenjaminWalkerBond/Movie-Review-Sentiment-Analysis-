...
public class MovieReviewCount {
     ...
     * for negative
     * @return number of movie reviews in a collection classified as positive
     * @throws IOException
     */
    public int classifyCollection(ArrayList<String> fileList, ReviewScore score) throws IOException {

        //String label = (gt > 0) ? "positive" : "negative";
        int counter = 0;
        ReviewScore currSent;
        String currStr;
        for (String filePath : fileList) {
            ...
            System.out.println("Ground truth is " + score.toString() + ", predicted sentiment is " + currSent.toString() + "\n");
            // Close the file
            inFile.close();
            if (currSent == ReviewScore.POSITIVE){
                    counter++;
            }
        }
        return counter;
     ...
     *
     */
    public ReviewScore classifyReview(String currStr) {
